"""
Django settings for todomir project.
...
from celery.utils.time import os
...
SECRET_KEY = os.getenv("DJANGO_SECRET", "super_secret")
...
WSGI_APPLICATION = "todomir.wsgi.application"
